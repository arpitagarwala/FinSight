  ...
  if (success) return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: 'var(--bg-primary)' }}>
      <div className="card text-center max-w-md animate-fade-in">
        ...
        <p className="text-slate-400 text-sm mb-6">We sent a confirmation link to <strong className="text-white">{email}</strong>. Click it to activate your account.</p>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: 'var(--bg-primary)' }}>
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-purple-600/8 rounded-full blur-3xl" />
      ...
      <div className="w-full max-w-md animate-fade-in relative">
        ...
        <div className="card">
          <button onClick={handleGoogle} disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-[#2a2a3e] bg-[#0f0f1a] hover:bg-[#1a1a2e] transition-all text-sm font-medium text-slate-300 mb-6">
          ...
          <div className="flex items-center gap-3 mb-6">
            <div className="flex-1 h-px bg-[#1e1e2e]" /><span className="text-xs text-slate-600">or email</span><div className="flex-1 h-px bg-[#1e1e2e]" />
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" value={name} onChange={e => setName(e.target.value)}
                  className="input pl-10" placeholder="Arpit Sharma" required />
              </div>
            </div>
            <div>
